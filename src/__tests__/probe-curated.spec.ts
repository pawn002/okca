...
const DARK_ON_LIGHT: ProbePair[] = [
  ...
  ['#333333', '#ffffff',  9.5, 'I  dark gray on white'],
  ['#555555', '#ffffff',  5.5, 'I  mid-dark gray on white'],
  ['#595959', '#ffffff',  5.1, 'I  #595959 on white'],
  ['#767676', '#ffffff',  3.2, 'I  #767676 on white (AA boundary)'],
  ['#777777', '#ffffff',  3.1, 'I  #777777 on white (just below AA)'],
  ['#444444', '#eeeeee',  6.2, 'I  dark gray on near-white'],
  ['#333333', '#cccccc',  5.8, 'I  dark gray on light gray'],

  // J: Dark green text on white
  ['#004000', '#ffffff',  9.3, 'J  very dark green on white'],
  ['#006400', '#ffffff',  5.5, 'J  dark green on white'],
  ['#006600', '#ffffff',  5.4, 'J  #006600 on white'],
  ['#007700', '#ffffff',  4.2, 'J  #007700 on white'],
  ['#008000', '#ffffff',  3.7, 'J  #008000 on white'],
  ['#008900', '#ffffff',  3.3, 'J  #008900 on white (boundary)'],
  ['#228b22', '#ffffff',  3.1, 'J  forest green on white'],
  ['#3a7d44', '#ffffff',  3.6, 'J  forest-ish green on white'],
  ['#556b2f', '#ffffff',  4.4, 'J  dark olive on white'],
  ['#2ca02c', '#ffffff',  2.3, 'J  D3 green on white'],
  ...
  ['#003399', '#ffffff',  7.7, 'K  dark blue on white'],
  ['#0057b7', '#ffffff',  4.9, 'K  D3 blue on white'],
  ['#0d47a1', '#ffffff',  6.2, 'K  blue 900 on white'],
  ['#1a237e', '#ffffff',  9.5, 'K  indigo 900 on white'],
  ['#000080', '#e3f2fd',  9.8, 'K  navy on very light blue bg'],

  // L: Dark purple/indigo text on white
  ['#4b0082', '#ffffff',  8.8, 'L  indigo on white'],
  ['#6a0dad', '#ffffff',  6.0, 'L  purple on white'],
  ['#800080', '#ffffff',  6.2, 'L  pure purple on white'],
  ['#8b008b', '#ffffff',  5.5, 'L  dark magenta on white'],

  // M: Dark red text on white
  ['#8b0000', '#ffffff',  6.8, 'M  dark red on white'],
  ['#800000', '#ffffff',  7.6, 'M  maroon on white'],
  ['#b22222', '#ffffff',  4.4, 'M  firebrick on white'],
  ['#d62728', '#ffffff',  3.2, 'M  D3 red on white'],

  // N: Dark teal text on white
  ['#004c4c', '#ffffff',  7.5, 'N  very dark teal on white'],
  ['#006666', '#ffffff',  5.1, 'N  dark teal on white'],
  ['#007070', '#ffffff',  4.4, 'N  #007070 on white'],
  ...
  ['#2c2c2c', '#f8f8f8',  9.9, 'P  body text on off-white'],
  ['#444444', '#ffffff',  7.2, 'P  medium dark on white'],
  ['#1e3a5f', '#ffffff',  8.6, 'P  dark navy blue on white'],
  ['#2d4a1e', '#ffffff',  7.6, 'P  dark forest text on white'],
  ['#5c1a1a', '#ffffff',  9.3, 'P  dark burgundy on white'],
  ['#1a1a5c', '#ffffff', 11.4, 'P  very dark indigo on white'],
];
