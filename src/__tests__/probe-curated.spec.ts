...
const DARK_ON_LIGHT: ProbePair[] = [
  // I: Achromatic BoW
  ['#000000', '#ffffff', 14.7, 'I  black on white'],
  ['#333333', '#ffffff',  8.8, 'I  dark gray on white'],
  ['#555555', '#ffffff',  5.2, 'I  mid-dark gray on white'],
  ['#595959', '#ffffff',  4.9, 'I  #595959 on white'],
  ['#767676', '#ffffff',  3.2, 'I  #767676 on white (AA boundary)'],
  ['#777777', '#ffffff',  3.1, 'I  #777777 on white (just below AA)'],
  ['#444444', '#eeeeee',  5.9, 'I  dark gray on near-white'],
  ['#333333', '#cccccc',  5.5, 'I  dark gray on light gray'],

  // J: Dark green text on white
  ['#004000', '#ffffff',  8.6, 'J  very dark green on white'],
  ['#006400', '#ffffff',  5.3, 'J  dark green on white'],
  ['#006600', '#ffffff',  5.1, 'J  #006600 on white'],
  ['#007700', '#ffffff',  4.1, 'J  #007700 on white'],
  ['#008000', '#ffffff',  3.6, 'J  #008000 on white'],
  ['#008900', '#ffffff',  3.2, 'J  #008900 on white (boundary)'],
  ['#228b22', '#ffffff',  3.1, 'J  forest green on white'],
  ['#3a7d44', '#ffffff',  3.6, 'J  forest-ish green on white'],
  ['#556b2f', '#ffffff',  4.3, 'J  dark olive on white'],
  ['#2ca02c', '#ffffff',  2.4, 'J  D3 green on white'],
  ['#808000', '#ffffff',  3.0, 'J  olive on white'],
  ['#228b22', '#f0fff0',  3.0, 'J  forest green on honeydew'],

  // K: Dark blue text on white
  ['#000080', '#ffffff', 10.5, 'K  navy on white'],
  ['#003399', '#ffffff',  7.3, 'K  dark blue on white'],
  ['#0057b7', '#ffffff',  4.7, 'K  D3 blue on white'],
  ['#0d47a1', '#ffffff',  5.9, 'K  blue 900 on white'],
  ['#1a237e', '#ffffff',  8.9, 'K  indigo 900 on white'],
  ['#000080', '#e3f2fd',  9.2, 'K  navy on very light blue bg'],

  // L: Dark purple/indigo text on white
  ['#4b0082', '#ffffff',  8.3, 'L  indigo on white'],
  ['#6a0dad', '#ffffff',  5.7, 'L  purple on white'],
  ['#800080', '#ffffff',  5.9, 'L  pure purple on white'],
  ['#8b008b', '#ffffff',  5.3, 'L  dark magenta on white'],

  // M: Dark red text on white
  ['#8b0000', '#ffffff',  6.5, 'M  dark red on white'],
  ['#800000', '#ffffff',  7.1, 'M  maroon on white'],
  ['#b22222', '#ffffff',  4.3, 'M  firebrick on white'],
  ['#d62728', '#ffffff',  3.2, 'M  D3 red on white'],

  // N: Dark teal text on white
  ['#004c4c', '#ffffff',  7.0, 'N  very dark teal on white'],
  ['#006666', '#ffffff',  4.9, 'N  dark teal on white'],
  ['#007070', '#ffffff',  4.2, 'N  #007070 on white'],
  ['#008080', '#ffffff',  3.4, 'N  teal on white'],
  ['#009090', '#ffffff',  2.8, 'N  #009090 on white'],

  // O: Light chromatic backgrounds
  ['#000000', '#90ee90',  7.4, 'O  black on light green'],
  ['#000000', '#add8e6',  9.2, 'O  black on light blue'],
  ['#000000', '#ffff99', 13.4, 'O  black on light yellow'],
  ['#000000', '#ffcccc', 10.2, 'O  black on light pink'],
  ['#000000', '#e6ccff',  9.7, 'O  black on light lavender'],
  ['#333333', '#90ee90',  4.4, 'O  dark gray on light green'],
  ['#1a237e', '#e3f2fd',  7.7, 'O  dark navy on very light blue'],
  ['#004d00', '#e8f5e9',  6.4, 'O  very dark green on near-white green bg'],

  // P: Mixed real-world BoW pairs
  ['#1a1a1a', '#ffffff', 12.2, 'P  near-black on white'],
  ['#2c2c2c', '#f8f8f8',  9.2, 'P  body text on off-white'],
  ['#444444', '#ffffff',  6.8, 'P  medium dark on white'],
  ['#1e3a5f', '#ffffff',  8.0, 'P  dark navy blue on white'],
  ['#2d4a1e', '#ffffff',  7.1, 'P  dark forest text on white'],
  ['#5c1a1a', '#ffffff',  8.7, 'P  dark burgundy on white'],
  ['#1a1a5c', '#ffffff', 10.6, 'P  very dark indigo on white'],
];
